...
import { TeamSummaryDetail } from "../../../components/AssigneeSummaryBoard";
    ...
    <div className='flex flex-col max-w-screen-2xl mx-auto w-full py-8 px-4 gap-8 select-none'>
      <div className='flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between'>
        <div className='space-y-2'>
          <p className='text-sm uppercase tracking-[0.24em] text-cyan-300'>Team summary</p>
          <h1 className='text-4xl font-bold text-white'>Team workload health</h1>
          <p className='max-w-2xl text-slate-400'>See the most loaded teammates and which assignee is carrying overdue work.</p>
        </div>
